...
const kPrimaryColor = Colors.blue; // Définissez votre couleur principale ici
const kOtherColor = Colors.white; // Définissez votre autre couleur ici
const kTextLightColor = Colors.grey; // Définissez votre couleur de texte clair ici
const kTextBlackColor = Colors.black; // Définissez votre couleur de texte noir ici
const kTextWhiteColor = Colors.white; // Définissez votre couleur de texte blanc ici
const kErrorBorderColor = Colors.red; // Définissez votre couleur de bordure d'erreur ici
